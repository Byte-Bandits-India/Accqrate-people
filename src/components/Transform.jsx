    ...
    <>
      <div className="px-[24px] md:px-[32px] max-w-[1280px] mx-auto font-inter">
        ...
        <p className="mb-6 text-[#000000B2] lg:text-fluid-body text-[14px] md:text-[16px] text-center">
          Accqrate People brings your HR & Payroll processes together in one unified platform. Forget <br className="hidden md:block" /> endless spreadsheets, outdated systems, and manual errors. Accqrate People is designed to <br className="hidden md:block" /> automate and simplify:
        </p>
        ...
        md:grid md:grid-cols-2 md:max-w-5xl mx-auto"
        >
          <AccordionCard
            value="card-1"
      ...
      <div className="mt-[24px] px-[24px]">
        <div
          className="bg-gradient-to-r from-[#E6E6E6] to-[#C8C8C8] rounded-lg mx-auto
              p-6 sm:p-6 md:px-10 md:max-w-5xl
              h-auto sm:h-[110px] md:h-[129px] lg:h-[182px]
              flex flex-col items-center justify-center"
        >
          <div className="max-w-[1000px] w-full">
            <p className="text-fluid-body tracking--2 font-normal text-[#333333] md:leading-10 text-left">
